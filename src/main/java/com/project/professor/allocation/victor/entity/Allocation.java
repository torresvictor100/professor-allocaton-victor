...
public class Allocation {
	...
	// @Enumerated(EnumType.STRING) ele salva o texto correspondente ao valor do
	// Enum.
	...
	@ApiModelProperty(example = "19:00-0300")//depois tentar entender um pouco melhor esse
